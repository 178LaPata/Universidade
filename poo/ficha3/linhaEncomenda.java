public class linhaEncomenda {
    ...
    public linhaEncomenda(String ref, String des, Double pre, int quan, int imp, int desc) {
        this.referencia = ref;
        this.descricao = des;
        this.preco = pre;
    ...
    public double calculaValorLinhaEnc(){
        //double valorVenda;
        //valorVenda = (this.preco * this.quantidade);
        //valorVenda = valorVenda * this.desconto/100;
        //valorVenda = valorVenda * this.imposto/100;
        //return valorVenda;
    
        double precoTotal = this.preco * this.quantidade;
        double desconto = precoTotal * this.desconto/100;
        double imposto = precoTotal * this.imposto/100;
